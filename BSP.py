...
def construct_bsp_tree(lines):
    ...
    # Choose a random line as the partitioning line
    partition_line = random.choice(lines)
...
if __name__ == "__main__":
    ...
    lines = [Line((-3, 2), (3, 2)), Line((-2, 2), (-2, -3)), Line((2, 2), (2, -3)),
             Line((-2, -2), (2, -2)), Line((0, 1), (0, 0)), Line((1, 0), (0, 0)),
             Line((1, 1), (0, 1))]
